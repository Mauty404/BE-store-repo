...
const producers_controller_1 = require("../controlers/producers.controller");
...
ProducersModule = __decorate([
    common_1.Module({
        imports: [typeorm_1.TypeOrmModule.forFeature([producer_entity_1.Producer, product_entity_1.Product])],
